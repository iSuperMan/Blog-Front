...
export default compose(
	connect(
		...
		{
			getDraftStoriesByUser: storiesAPI.actions.getDraftStoriesByUser,
	...
	withHandlers({
		...
		itemClickHandleCreator: props => story => () => props.history.push(`/p/${story._id}`),
	}),

	lifecycle({
		componentDidMount() {
			this.props.getDraftStoriesByUser(this.props.user._id);
		},
	}),
)(StoriesList);
